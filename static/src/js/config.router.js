                ...
                $stateProvider
                        ...
                        resolve: {
                            deps: ['$$animateJs','$ocLazyLoad',
                                function ($$animateJs,$ocLazyLoad) {
                                    return $ocLazyLoad.load(['cgBusy','ui.grid','js/services/util_tool.js']);
                                }
                            ]
                        }
                    })
                        ...
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    ...
                                    return $ocLazyLoad.load(['ngMessages',"js/filters/agent_level.js","js/filters/enable.js",'js/controllers/home.js', 'js/directives/passwordRight.js', 'js/directives/passwordEqually.js',
                                        'js/directives/passwordDifferent.js', 'js/directives/menusChecked.js','js/services/grid_tool.js']);
                    ...
                    .state('access.signin', {
                        ...
                        resolve: {
                            deps: ['uiLoad',
                                function (uiLoad) {
                                    return uiLoad.load(['js/services/util_tool.js','js/controllers/signin.js']);
                                }]
                        }
                    })
